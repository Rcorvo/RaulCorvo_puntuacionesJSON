package com.example.rcu19.puntuacionesjson;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String urlObtener =
            "http://proves.iesperemaria.com/asteroides/puntuaciones/";
    private static final String urlGrabar =
            "http://proves.iesperemaria.com/asteroides/puntuaciones/nueva/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerPuntuaciones =
                (Button) findViewById(R.id.btnVerPuntuaciones);
        btnCrearPuntuacion =
                (Button) findViewById(R.id.btnCrearPuntuacion);
        puntos =
    ...
    private void crearPuntuacion() {
        ...
        new NuevaPuntuacion().execute(puntos.toString(),
                "ALUMNO DAM", fecha.toString());
    }
    ...
    class NuevaPuntuacion extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                parametros.add(
                        new BasicNameValuePair("puntos",params[0]));
                parametros.add(
                        new BasicNameValuePair("nombre",params[1]));
                parametros.add(new BasicNameValuePair("fecha",params[2]));
                return jsonManager.getJsonString(urlGrabar,"POST",
                        parametros);
            } catch (Exception e) {
                e.printStackTrace();
            }
